package za.ac.cput.ui.equipment.storageActions;
...
public class UIStorageLocationAdd extends JFrame implements ActionListener {
    private JLabel lblTitle;
    private JTextField txtFName, txtLName, txtEmail, txtPassword;
    private JComboBox cbAccountType;

    public UIStorageLocationAdd(int x, int y) {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("SAVE")) {
            ...
            String shelfSpce = txtFName.getText();
            String equipmentId = txtLName.getText();
            //Create a new object
            EquipmentStorage equipmentStorage = EquipmentStorageFactory.createStorageFactory(shelfSpce,equipmentId);
            System.out.println(equipmentStorage);
        }
