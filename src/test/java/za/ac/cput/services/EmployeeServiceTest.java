...
class EmployeeServiceTest {
    ...
    private static Employee employee = EmployeeFactory.createEmployee("Ty", "Lloyd", "Ty@gmail.com", 215141210, "1");
    @Test
    void a_create() {
    ...
    @Test
    void c_update() {
        Employee update = new Employee.Builder().copy(employee).setName("Tyronne").build();
